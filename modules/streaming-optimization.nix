...
in {
  options.my.streaming = {
    ...
    interface = mkOption {
      ...
      default = null;
      description = "Primary ethernet interface for streaming. When null, interface-specific tuning is skipped.";
    };
  ...
  config = mkIf cfg.enable (mkMerge [
    ...
    # ===========================================
    # INTERFACE-SPECIFIC TUNING (only when interface is set)
    # ===========================================
